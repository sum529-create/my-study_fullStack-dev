...
public class EmailCheckCommand implements EmailCommand {
	...
	public Map<String, Object> execute(SqlSession sqlSession, Model model) {
		...
		try {
			...
			InternetAddress to = new InternetAddress(request.getParameter("mailCheck"));  
			...
			message.setText("안녕하십니까 회원님 \n" + "저희 Classick을 찾아 주셔서 감사합니다.\n" + " 아래 인증코드를 입력하여 회원가입을 완료해주세요. \n" + "감사합니다\n" + "\n" + "인증코드 : " + authKey);  
