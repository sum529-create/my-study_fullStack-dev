...
class Daughter extends Mother{
	...
	Daughter(){
		...
		// 반드시 슈퍼클래스의 constructor가 먼저 호출되어야한다.
...
public class Ex04_constructor {
	...
	public static void main(String[] args) {
		...
		// 서브클래스만 생성한다.
		@SuppressWarnings("unused")		// unused 가지고 경고 띄우지 말것
		Daughter d = new Daughter();	// 서브클래스의 constructor을 호출
										// 실제로는 수퍼클래스의 constructor가 먼저 호출된다.
