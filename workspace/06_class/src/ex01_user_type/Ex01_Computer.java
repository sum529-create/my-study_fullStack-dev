...
// 파일명과 같은 이름의 클래스만 public으로 둘 수 있다.
...
public class Ex01_Computer {
	...
	public static void main(String[] args) {
		...
		Computer myCom = new Computer();	// class object = 
		myCom.model = "GRAM";
		myCom.maufacturer = "LG";
		myCom.price = 180;
		
		Computer yourCom = new Computer();
		yourCom.model = "SENSE";
		yourCom.maufacturer = "SAMSUNG";
		yourCom.price = 180;
		
		// 객체 자체 확인
		System.out.println(myCom);	// myCom의 주소 확인
		// 객체 필드 확인
		System.out.println(myCom.model);
		System.out.println(myCom.maufacturer);	
