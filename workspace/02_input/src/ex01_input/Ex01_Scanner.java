...
public class Ex01_Scanner {
	...
	public static void main(String[] args) {
		 ...
		 * 5. Double
		 * 
		 * java.lang 패키지에 저장된 클래스들은 import가 필요없다.
		 * 
		 * Scanner 클래스
		 * 
		 ...
		 * 			- nextBoolean()
		 * 		4) 문자열 입력
		 * 			- next()	: 공백 문자 전까지 입력받음 (공백의 입력이 불가능)
		 * 			- nextLine(): 엔터 전까지 입력받음 		(공백의 입력이 가능)
		 * 		5) 문자 입력
		 * 			- 메소드가 없다.
